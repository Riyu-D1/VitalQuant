    ...
    <div className="pt-32 pb-20 px-6 lg:px-8 max-w-7xl mx-auto flex flex-col gap-10">
      <div className="text-center">
        ...
        <p className="text-xl text-gray-400 max-w-3xl mx-auto">
          Experience the quantum advantage. Adjust the timeline to see how our quantum-enhanced detection identifies faint biomarker signals earlier than classical methods.
        </p>
      </div>
      ...
      <div className="bg-gray-900/50 border border-gray-800 rounded-2xl p-8 backdrop-blur-sm">
        ...
        <input 
          ...
          className="w-full h-3 bg-gray-800 rounded-lg appearance-none cursor-pointer accent-caladan-green outline-none mb-8"
        />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-gray-900/50 border border-gray-800 rounded-2xl p-8 backdrop-blur-sm flex flex-col">
          <h3 className="text-xl font-bold text-white mb-6 flex items-center gap-2">
            <Activity className="text-blue-400" /> Patient Vitals & Biomarkers
          </h3>
          <div className="grid grid-cols-2 gap-4 flex-grow">
            <div className="bg-gray-950 rounded-xl p-5 border border-gray-800 flex flex-col justify-center">
        ...
        <div className="flex flex-col gap-6">
          ...
          >
            <div>
              <h3 className="text-xl font-bold text-white mb-2">Classical System</h3>
          ...
          <div className={`rounded-2xl p-6 border transition-all duration-500 flex items-center justify-between
            ${quantumAlert 
                ? 'bg-caladan-green/10 border-caladan-green/50 shadow-[0_0_30px_rgba(46,204,113,0.1)]' 
                : 'bg-gray-900/50 border-gray-800'}`}
          >
            <div>
              <h3 className="text-xl font-bold text-white mb-2 flex items-center gap-2">Quantum System <Zap className="w-5 h-5 text-caladan-green" /></h3>
          ...
          {/* Metrics */}
          <div className="bg-gradient-to-br from-gray-900 to-gray-950 border border-gray-800 rounded-2xl p-6 mt-2 relative overflow-hidden">
            <div className="absolute top-0 right-0 p-4 opacity-5 pointer-events-none">
              <HeartPulse className="w-32 h-32" />
            </div>
            <h3 className="text-lg font-bold text-white mb-4 uppercase tracking-wider text-center">Clinical Outcomes</h3>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              ...
              <div className="text-center border-t md:border-t-0 md:border-l border-gray-800 col-span-2 md:col-span-1 pt-4 md:pt-0">
